...
// import amazon from './OMS/Amazon logo.png'
// import flipkart from './OMS/flipkart logo.png'
// import shopify from './OMS/shopify logo.png'
// import searchWhiteIcon from "./Icon.png";
import "./OMS Marketplace.css";
import NavBar from "./NavBar";
import OMSPurchaseWindow from "./OMSPurchaseWindow";
export default function OMSMarketPlace(props) {
  return (
    <>
      <NavBar />
      ...
      <div id="OMS-main-content">
        <div className="order-list-box">
            <div id="marketPlacePlatforms">
                {/* <img src={amazon} alt="" width={'100px'} height={'100px'}/>
                <img src={flipkart} alt="" width={'100px'} height={'100px'}/>
